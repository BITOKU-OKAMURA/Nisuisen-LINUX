...
cd $current
mkdir -p ./gateweb.dip.jp/result
func_shinzouget "gateweb.dip.jp/result"
cd $current
...
#find ./wp-content/* -name "*.css" |xargs tar rvf ~/tmp/atchive.tar
#find ./wp-content/* -name "*.js" |xargs tar rvf ~/tmp/atchive.tar
#find ./wp-includes/* -name "*.css" |xargs tar rvf ~/tmp/atchive.tar
#find ./wp-includes/* -name "*.js" |xargs tar rvf ~/tmp/atchive.tar
exit
